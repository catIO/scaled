...
export const SCALE_DICTIONARY: Record<string, ScaleDefinition> = {
  ...
  'Bb min Melodic': {
    name: 'Bb min Melodic',
    abc: 'X:1\nT:Bb min Melodic\nL:1/4\nK:Bbm\nB, C D E F =G =A B _A _G F E D C B, |]'
  },
  'C min Harmonic': {
    name: 'C min Harmonic',
    abc: 'X:1\nT:C min Harmonic\nL:1/4\nK:Cm\nC D E F G A =B c =B A G F E D C |]'
  ...
  'C min Melodic': {
    name: 'C min Melodic',
    abc: 'X:1\nT:C min Melodic\nL:1/4\nK:Cm\nC D E F G =A =B c _B _A G F E D C |]'
  },
  'C# min Harmonic': {
    name: 'C# min Harmonic',
    abc: 'X:1\nT:C# min Harmonic\nL:1/4\nK:C#m\nC D E F G A ^B c ^B A G F E D C |]'
  ...
  'D min Melodic': {
    name: 'D min Melodic',
    abc: 'X:1\nT:D min Melodic\nL:1/4\nK:Dm\nD E F G A =B ^c d =c _B A G F E D |]'
  },
  'D# min Harmonic': {
    name: 'D# min Harmonic',
    abc: 'X:1\nT:D# min Harmonic\nL:1/4\nK:D#m\nD E F G A B ^^c d ^^c B A G F E D |]'
  ...
  'F min Melodic': {
    name: 'F min Melodic',
    abc: 'X:1\nT:F min Melodic\nL:1/4\nK:Fm\nF G A B c =d =e f _e _d c B A G F |]'
  },
  'F# min Harmonic': {
    name: 'F# min Harmonic',
    abc: 'X:1\nT:F# min Harmonic\nL:1/4\nK:F#m\nF G A B c d ^e f ^e d c B A G F |]'
  ...
  'G min Melodic': {
    name: 'G min Melodic',
    abc: 'X:1\nT:G min Melodic\nL:1/4\nK:Gm\nG A B c d =e ^f g =f _e d c B A G |]'
  },
  'G# min Harmonic': {
    name: 'G# min Harmonic',
    abc: 'X:1\nT:G# min Harmonic\nL:1/4\nK:G#m\nG A B c d e ^^f g ^^f e d c B A G |]'
...
export function generateMultiOctaveABC(baseDef: ScaleDefinition, octaves: number): string {
  ...
  for (let i = 0; i < octaves; i++) {
    ...
    if (i === octaves - 1) {
      ...
      finalAscend.push(...shiftNotesBy(ascHalf.slice(0, 7), shiftAmt));
    }
  }
